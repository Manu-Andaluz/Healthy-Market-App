    ...
    <div className="flex shadow-md my-10">
      <div className="w-3/4 bg-white px-10 py-10">
        ...
        <div className="flex mt-10 mb-5">
          <h3 className="font-semibold text-gray-600 text-xs uppercase w-2/5">Detalle de producto</h3>
...

        {
          ...
          <div className="flex justify-center w-1/5">
            ...
            <input className="mx-2 border text-center w-8" type="text" value={product.cartQuantity}/>
      ...
      <div id="summary" className="w-1/4 px-8 py-10">
        ...
        <button className="bg-green-500 hover:bg-red-600 px-5 py-2 text-sm text-white uppercase">Apply</button>
