            ...
            <div className="container px-5 py-24 mx-auto ">
                <div className="flex flex-col text-center w-full mb-12">
                    ...
                    <p className="font-bree text-base leading-6 text-gray-600 px-8">
                        ...
                        en que <span class="font-bold">Healthy Market app</span> usa y protege la información que
                        es proporcionada por sus usuarios al momento de utilizar su
                    ...
                    <br />
                    <h2 className="text-lg font-bold leading-6 text-gray-700 ">
                    ...
                    <p className="font-bree text-base leading-6 text-gray-600 px-8">
                        ...
                        e información demográfica. Así mismo cuando sea necesario podrá ser requerida
                    ...
                    <br />
                    <p className="font-bree text-base leading-6 text-gray-600 px-8">
                        <span class="font-bold">Healthy Market app</span> está altamente comprometido para cumplir con el compromiso de mantener su información
                    ...
                    <p className="font-bree text-base leading-6 text-gray-600 px-8">
                        ...
                        facilita las futuras visitas a una web recurrente. Otra función que tienen las cookies es que con ellas las
                    ...
                    <p className="font-bree text-base leading-6 text-gray-600 px-8">
                        ...
                        forma permanente. Usted puede eliminar las cookies en cualquier momento desde su ordenador.
                    </p>
                    <br />
                    <p className="font-bree text-base leading-6 text-gray-600 px-8">
                        ...
                        noticias. Usted puede aceptar o negar el uso de cookies, sin embargo la mayoría de navegadores aceptan cookies
                    ...
                    <p className="font-bree text-base leading-6 text-gray-600 px-8">
                        ...
                        Una vez que usted de clic en estos enlaces y abandone nuestra página, ya no tenemos control sobre al sitio al que es redirigido
                        y por lo tanto no somos responsables de los términos o privacidad ni de la protección de sus datos en esos otros sitios terceros.
                        Dichos sitios están sujetos a sus propias políticas de privacidad por lo cual es recomendable que los consulte para confirmar que
                    ...
                    <br />
                    <p className="font-bree text-base leading-6 text-gray-600 px-8">En cualquier momento usted puede restringir la recopilación o el uso de la información personal que es proporcionada a nuestro sitio web.
                        Cada vez que se le solicite rellenar un formulario, como el de alta de usuario, puede marcar o desmarcar la opción de recibir
                        información por correo electrónico.  En caso de que haya marcado la opción de recibir nuestro boletín o publicidad usted puede
                        cancelarla en cualquier momento.
                    </p>
                    <p className="font-bree text-base leading-6 text-gray-600 px-8">Esta compañía no venderá, cederá ni distribuirá la información personal que es recopilada sin su consentimiento,
                        salvo que sea requerido por un juez con un orden judicial.
                    </p>
                    <p className="font-bree text-base leading-6 text-gray-600 p-10">
                        <span class="font-bold">Healthy Market app</span> Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier momento.
                    </p>
                </div>
            </div>
        </div>
